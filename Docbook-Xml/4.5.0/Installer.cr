class Target < ISM::Software
    ...
    def prepareInstallation
        ...
        copyFile(   "#{buildDirectoryPath}docbook.cat",
                    "#{builtSoftwareDirectoryPath}#{Ism.settings.rootPath}usr/share/xml/docbook/xml-dtd-4.5/docbook.cat")

        copyFile(   "#{buildDirectoryPath}*.dtd",
                    "#{builtSoftwareDirectoryPath}#{Ism.settings.rootPath}usr/share/xml/docbook/xml-dtd-4.5")

        copyDirectory(  "#{buildDirectoryPath}ent",
                        "#{builtSoftwareDirectoryPath}#{Ism.settings.rootPath}usr/share/xml/docbook/xml-dtd-4.5/ent")
    ...
    def install
        ...
        if !File.exists?("#{Ism.settings.rootPath}etc/xml/docbook")
            runXmlCatalogCommand("--noout --create /etc/xml/docbook")
        end
